...
export default function Update() {
  ...
  const defaultclinicdata = useSelector((state) => state.clinicInfo.upData);
  ...
  const registr = async (event) => {
    ...
    try {
      setLoading(true);
      const URL = ApiUrls.CLINIC_UPDATE + defaultclinicdata.id;
      const response = await ApiServices.ClinicUpdateApi(URL, ob, user.token);
